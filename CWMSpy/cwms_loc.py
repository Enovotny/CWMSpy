...
class CwmsLocMixin:
    def retreive_loc_group(self,p_loc_group_id,p_category_id,p_office_id,output = 'dataframe'):
        ...
        responce = queryCDA(self,endPoint,params,headerList,output,dict_key = 'assigned-locations')
